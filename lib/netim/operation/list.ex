defmodule Netim.Operation.List do
  ...
  typed_embedded_schema do
    ...
    field :domain_set_preference_auto_renew, Ecto.Enum, values: @boolean, source: :"domainSetPreference.auto_renew"
    field :domain_set_preference_registrar_lock, Ecto.Enum, values: @boolean, source: :"domainSetPreference.registrar_lock"
    field :domain_set_preference_to_be_renewed, Ecto.Enum, values: @boolean, source: :"domainSetPreference.to_be_renewed"
    field :domain_set_preference_whois_privacy, Ecto.Enum, values: @boolean, source: :"domainSetPreference.whois_privacy"
