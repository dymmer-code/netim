defmodule Netim.Tld do
  ...
  typed_embedded_schema do
    ...
    field :has_immediate_delete?, Ecto.Enum, values: [true: 1, false: 0], source: :HasImmediateDelete
    field :has_local_contact_service?, Ecto.Enum, values: [true: 1, false: 0], source: :HasLocalContactService
    ...
    field :has_trustee_service?, Ecto.Enum, values: [true: 1, false: 0], source: :HasTrusteeService
